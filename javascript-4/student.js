...
let faveColors =['Green', 'Purple', 'Black'];
...
let me = { firstName: 'Eric', superHeroName:'SuperDad', homeTown:'Sacramento', superPowers:[ 'Super Strength', 'Dragon Breath', 'Prairie Dog Squasher'], superPowerXP: (Math.random() * 100) + 1, profileImage:url `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg` };
